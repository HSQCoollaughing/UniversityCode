							...
							<td bgcolor="#FFFFFF">
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<s:form action="login" target="_parent">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														...
														<td>
														<s:textfield id="logonName"  cssClass="text" cssStyle="width: 160px;" name="logonName"></s:textfield>
													...
													<tr>
														...
														<td>
														<s:password id="logonPwd" name="logonPwd" cssStyle="width: 160px;"  cssClass="text"></s:password>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
														<s:submit  name="submit" cssClass="buttoninput" value="登陆"></s:submit>
														<s:reset name="reset" value="重置" cssClass="buttoninput"></s:reset>
