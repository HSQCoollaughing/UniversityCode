...
<s:hidden name="courseTypeId" value="%{courseTypeId}"></s:hidden>
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  <tr>
	    <td width="10%">课程类别：</td>
	    <td width="20%"><s:textfield name="courseName" type="text"></s:textfield></td>
	    <td width="8%">总学时：</td>
	    <td width="62%"><s:textfield type="text" name="total"/></td>
	  </tr>
	  <tr>
	    <td>课程费用：</td>
	    <td><s:textfield type="text" name="courseCost" /></td>
	    <td></td>
	    <td></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td colspan="4"><s:textarea name="remark" cols="60" rows="10"/></td>
	  </tr>
	</table>
</s:form>
</body>
