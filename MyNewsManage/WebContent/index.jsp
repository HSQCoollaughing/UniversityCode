...
<div id="templatemo_container">
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="#">新闻列表</a></li>
            <li><a href="#">新闻查找</a></li>  
            <li><a href="admin/regist.jsp">注册</a></li> 
            <li><a href="admin/NewFile.jsp">后台登录</a></li>                     
            <li><a href="#">关于</a></li>            
        </ul> 
	</div>
    	...
    	<div id="templatemo_main_leftcol">
        	<div class="templatemo_leftcol_subcol">
            	...
            	<div id="templatemo_topnews">
                    ...
                    <p align="justify">
                    This website template is provided by <a href="#">TemplateMo.com</a> for FREE of charge. Feel free to use this web layout for your websites. Photos are from <a rel="nofollow" href="http://www.publicdomainpictures.net/" target="_blank">PublicDomainPictures</a>.</p>
            ...
            <div class="templatemo_leftcol_subcol">
				<div class="regular_section">
                    <h2>国内新闻</h2>
					<div class="newsbox"><img src="images/templatemo_image_08.jpg" alt="image" /><span class="newstitle">News Title 01</span><br />
                        <p>
                   ...
                   <c:forEach  items="${ Newslist}"  var="d">
                        <li><a href="FirstAction?method=showNews&id=${ d.id}">${ d.title}</a></li>
                ...
                <div class="regular_section">
                    <h2>Sports</h2>
					<div class="newsbox"><img src="images/templatemo_image_12.jpg" alt="image" /><span class="newstitle">News Title 02</span><br />
                        <p>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
    ...
    <div id="templatemo_footer">
    	<div class="footer_leftcol">
	        Copyright © 2020 <a href="#"><strong>Your Company Name</strong></a> 
            <!-- Credit: www.templatemo.com --><br /><br />
