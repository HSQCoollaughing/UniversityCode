<%@page import="com.hsq.services.UserServices"%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr><td height="32" align="center" class="word_orange ">欢迎来到Coollaughing聊天室！</td></tr>
  <tr>
...
<c:forEach var="entry" items="${ userMap }">
  <tr>
    <td height="23" align="center">
    	...
    	<a href="#" onclick="set('${ entry.key.loginName }')">${ entry.key.loginName }</a> 
