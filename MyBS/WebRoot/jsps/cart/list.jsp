	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/MyBS/CartItemServlet?method=DeleteCartItem&cartItemIds=" + id;
			}
		} else {
...
function batchDelete() {
	...
	location = "/MyBS/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
...
<c:forEach items="${cartitemList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="400px">
		    <a href="<c:url value='/BookServlet?method=Bookdesc&bid=${cartItem.book.bid}'/>"><span>${cartItem.book.bname }</span></a>
		</td>
		...
		<td>
			<a href="<c:url value='/CartItemServlet?method=DeleteCartItem&cartItemIds=${cartItem.cartItemId }'/>">删除</a>
		</td>
	</tr>
</c:forEach>
	...
	<form id="jieSuanForm" action="<c:url value='/CartItemServlet'/>" method="post">
		...
		<input type="hidden" name="method" value="LookCartItemsinfo"/>
	</form>
